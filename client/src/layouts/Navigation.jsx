    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center lg:space-x-2">
        ...
        <div id="myCartDropdown1" className="hidden z-10 mx-auto max-w-sm space-y-4 overflow-hidden rounded-lg bg-white p-4 antialiased shadow-lg dark:bg-gray-800">
          ...
          <div className="grid grid-cols-2">
            <div>
              <Link href="#" className="truncate text-sm font-semibold leading-none text-gray-900 dark:text-white hover:underline">Apple iPad Air</Link>
          ...
          <div className="grid grid-cols-2">
            <div>
              <Link href="#" className="truncate text-sm font-semibold leading-none text-gray-900 dark:text-white hover:underline">Apple Watch SE</Link>
          ...
          <div className="grid grid-cols-2">
            <div>
              <Link href="#" className="truncate text-sm font-semibold leading-none text-gray-900 dark:text-white hover:underline">Sony Playstation 5</Link>
          ...
          <div className="grid grid-cols-2">
            <div>
              <Link href="#" className="truncate text-sm font-semibold leading-none text-gray-900 dark:text-white hover:underline">Apple iMac 20"</Link>
